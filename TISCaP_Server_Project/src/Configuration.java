...
public class Configuration extends DefaultHandler {
	 ...
	 * @param attrs
	 *            the set of attributess associated with the element
	 */
	public void startElement(String namespaceURI, String lName, String qName,
		...
		/**
		 * Get the attributes associated with this ELEMENT. Attributes are
		 * name/value pairs and are stored by index.
		 */
		if (attrs != null) {
